          ...
          case 5: // GLOBALES ::= 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("GLOBALES",1, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 39: // LINEA_AUX ::= 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("LINEA_AUX",29, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
